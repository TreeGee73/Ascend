let GameManager = {
    ...
    setFight: function() {
        ...
        let enemy4 = new Enemy("Goblin Rider", 100, 70, 10, 60, 110, "goblin-rider.jpg");
        ...
        getActions.innerHTML = '<a href="#" class="btn-attack" onclick="PlayerMoves.calcAttack()"><button class="btn btnAttack" id="start">Attack!</button></a>' + '<a href="#" class="btn-flee" onclick="PlayerMoves.flee()"><button class="btn btnFlee">Flee!</button></a>';
        ...
        getEnemy.innerHTML =`<div class="col-md-8">
        <h2 class="enemy-name">${enemy.classType}</h2></div><div class="col-md-4"><h2 class="champ-health" id="enemy-health">HP: ${enemy.health}</h2></div></div><div class="row"><div class="col-md-5"><div class="col-md-5"><img src="../public/assets/images/${enemy.image}" class="char-pix" alt="${enemy.classType}" /></div></div>`;
    }
  }