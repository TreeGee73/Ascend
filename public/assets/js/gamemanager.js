let GameManager = {
    ...
    setFight: function() {
        ...
        '<a href="#" class="btn-flee" onclick="PlayerMoves.flee()"><button class="btn btn-attack">Flee!</button></a>';
